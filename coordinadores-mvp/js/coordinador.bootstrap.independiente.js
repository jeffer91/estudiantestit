...
(function(window,document){
  ...
  function verificarSoporteTrabajo(){var servicio=window.CoordinadorMVPSheetsPrimary;if(!servicio||servicio.soportaTrabajoTitulacion!==true||servicio.version!==VERSION){throw new Error('Se detectó una versión anterior del panel. Actualiza la página para cargar Coordinadores '+VERSION+'.');}}
