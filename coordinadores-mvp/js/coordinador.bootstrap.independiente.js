...
(function(window,document){
  ...
  window.CoordinadorMVPBootstrapIndependiente=Object.freeze({version:VERSION,assetVersion:ASSET_VERSION,apiBase:apiBase});
})(window,document);