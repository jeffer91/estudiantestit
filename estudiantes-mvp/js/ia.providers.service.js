...
(function(window,document){
  ...
  function proxyUrl(){var f=texto(window.ESTUDIANTE_IA_PROXY_URL||'');if(f)return f;if(esLocal())return 'http://127.0.0.1:8787/api/ia';return new URL('/api/ia',window.location.origin).toString();}
