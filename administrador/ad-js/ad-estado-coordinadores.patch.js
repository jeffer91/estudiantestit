/* Estado general del Administrador: carga pendiente real por coordinador, sin limitar por período ni tipo de trabajo. */
(function(window, document){
  ...
  function coordinadorNormal(raw, index){
    ...
    var activo = raw.activo !== false && texto(raw.estado || 'ACTIVO').toUpperCase() !== 'INACTIVO';
    return {
