(function(window){
  ...
  cargarComplemento('./ad-js/ad-pdf-firebase.js?v=3.6.3','data-ad-pdf-firebase');
  cargarComplemento('./ad-js/ad-version.js?v=3.6.3','data-ad-version');
})(window);
